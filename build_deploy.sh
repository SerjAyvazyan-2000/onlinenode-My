...
# Параметры
NAMESPACE="deflationcoin"               # Пространство имен, по умолчанию "default"
IMAGE_NAME="defcoinapp"       # Новый образ, который вы хотите установить
KUBECONFIG_PATH="deflation_config.yaml" # Путь к файлу конфигурации kubeconfig
VERSION_FILE="app_version"
DEPLOYMENT_PATH="kubernetes/deployment.yml" # Путь к файлу деплоймента
SERVICE_PATH="kubernetes/service.yml"
INGRESS_PATH="kubernetes/ingress.yml"
...
sed -i '' "s|image: deflationcoin.ru/defcoinapp:.*|image: $FULL_IMAGE|" "$DEPLOYMENT_PATH"
